...
Using the program
____________________________________________________________________________________________________
1) Begin by cloning this repository as a new project within IntelliJ IDEA or
a similar Java IDE. Ensure that all dependencies were properly installed, and
that no compilation errors occur when building the project. 

2) Initialize a new database utilizing pgAdmin4 (PostgreSQL) named
...
3) Open the Query Tool for the new database, then copy/paste the text found within
...
4) The database is now fully implemented and populated. A main executable method
